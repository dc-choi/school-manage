...
export function GroupForm({ initialData, onSubmit, onCancel, isSubmitting, submitLabel }) {
    ...
    return (_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: submitLabel === '추가' ? '새 그룹' : '그룹 수정' }) }), _jsx(CardContent, { children: _jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [error && (_jsx("div", { className: "rounded-md border border-destructive/50 bg-destructive/10 p-3 text-sm text-destructive", children: error })), _jsxs("div", { className: "space-y-2", children: [_jsx(Label, { htmlFor: "name", children: "\uADF8\uB8F9\uBA85" }), _jsx(Input, { id: "name", value: name, onChange: (e) => setName(e.target.value), placeholder: "\uADF8\uB8F9\uBA85\uC744 \uC785\uB825\uD558\uC138\uC694", disabled: isSubmitting })] }), _jsxs("div", { className: "flex justify-end gap-2", children: [_jsx(Button, { type: "button", variant: "outline", onClick: onCancel, disabled: isSubmitting, children: "\uCDE8\uC18C" }), _jsx(Button, { type: "submit", disabled: isSubmitting, children: isSubmitting ? '저장 중...' : submitLabel })] })] }) })] }));
}
