...
| **Target Functional**     | 100% | 미소속 사용자 라우팅 수정 완료 + 출석 인원 분리 + 학생 검색 개선 (3/3건) |
...
| 우선순위 | 기능명 | SDD 상태 | 비고 |
|---------|--------|----------|------|
| P0 | 미소속 사용자 라우팅 수정 | ✅ 완료 | DashboardPage 미소속/pending 리다이렉트 추가 |
| P1 | 출석 인원 분리 표시 | ✅ 완료 | 달력 뷰에서 미사/교리 인원 별도 표시 |
