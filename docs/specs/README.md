...
| 학생 등록 관리        | `docs/specs/prd/student-registration.md`         | 작성 중             | 로드맵 2단계 (4단계 선행)  |
...
| P0   | 학생 등록 관리     | PRD 작성 중 | 연/학기 단위 등록 이력 관리 (Registration 테이블). 등록 시즌 대응. 4단계 "등록 관리"의 핵심 선행 (전자서명·보상 제외) |
