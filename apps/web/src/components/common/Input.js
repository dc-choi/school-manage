...
export const Input = forwardRef(function Input({ label, error, helperText, className = '', id, ...props }, ref) {
    ...
    return (_jsxs("div", { className: "w-full", children: [label && (_jsx("label", { htmlFor: inputId, className: "mb-1 block text-sm font-medium text-gray-700", children: label })), _jsx("input", { ref: ref, id: inputId, className: `
