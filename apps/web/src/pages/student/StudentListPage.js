...
export function StudentListPage() {
    ...
    // 삭제된 학생 목록
    const { students: deletedStudents, total: deletedTotal, totalPage: deletedTotalPage, currentPage: deletedCurrentPage, setPage: setDeletedPage, isLoading: isDeletedLoading, restore, isRestoring, } = useStudents({ initialDeleteFilter: 'deleted' });
    // 졸업생 목록
    const { students: graduatedStudents, total: graduatedTotal, totalPage: graduatedTotalPage, currentPage: graduatedCurrentPage, setPage: setGraduatedPage, isLoading: isGraduatedLoading, cancelGraduation, isCancellingGraduation, } = useStudents({ initialDeleteFilter: 'active', initialGraduatedFilter: 'graduated' });
    const handleSearch = () => {
    ...
    const graduatedColumns = [
        ...
        { key: 'contact', header: '연락처', render: (row) => formatContact(row.contact) },
        {
            key: 'graduatedAt',
            header: '졸업일',
            render: (row) => formatDateKR(row.graduatedAt),
        },
    ];
