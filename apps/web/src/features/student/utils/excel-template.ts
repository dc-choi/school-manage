...
const HEADERS = ['학년', '이름', '세례명', '성별', '전화번호', '축일', '나이', '비고', '등록 여부', '부모 연락처'];

const COLUMN_WIDTHS = [12, 10, 12, 6, 14, 8, 6, 20, 10, 16];
...
const HEADER_COMMENTS: string[] = [
    ...
    '비고 (선택) : 자유 입력',
    '선택 입력\nO: 등록, X 또는 빈 값: 미등록',
    '부모 연락처 (선택) : 하이픈·괄호·공백 포함 원본 입력 가능. 예: 010-1234-5678\n숫자만 입력 시 앞자리 0이 사라지면 셀 서식을 "텍스트"로 지정하세요.',
];
