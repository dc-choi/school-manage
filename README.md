...
| 모임 관리 | 교구/본당/모임 계층, 합류 요청 승인/거부, 회원 관리, 관리자 양도                                                             |
| 학년 관리 | 학년/부서 CRUD, 일괄 삭제, 학생 일괄 추가/제거                                                                               |
| 학생 관리 | 학생 CRUD, 일괄 삭제/복구, 졸업/졸업 취소, 등록 관리 (연도별), 엑셀 Import, 다중 그룹 소속 (N:M), 이름+세례명 중복 등록 경고 |
